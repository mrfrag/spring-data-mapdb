...
import org.springframework.data.mapdb.query.GuavaQueryCreator;
...
@Documented
@Inherited
@Import(MapDbRepositoriesRegistrar.class)
@QueryCreatorType(GuavaQueryCreator.class)
public @interface EnableMapDbRepositories {
	 ...
	 * instance. Defaults to {@link KeyValueRepositoryFactoryBean}.
	 *
	 * @return
	 */
